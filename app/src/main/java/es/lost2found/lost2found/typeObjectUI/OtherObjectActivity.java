...
public class OtherObjectActivity extends AppCompatActivity {
    ...
    private void processNewObject(Integer objectId) {
        ...
        String announceNameText = announceName.getText().toString();
        ...
        if(announceNameText.equalsIgnoreCase("")) {
            ...
            new saveObjectDB().execute(objectIdText, categorie, announceNameText, announceDescriptionText, null, null);
        }
    }
