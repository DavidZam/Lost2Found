...
public class HelpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String s = "<h2> <font color=#1976D2>¿Cómo funciona Lost2Found? </font></h2> &bull; Cuando una persona pierde un objeto lo notifica creando un anuncio de pérdida y rellenando los máximos campos posibles.<br><br>" +
                ...
                "<h2> <font color=#1976D2>¿Tengo que entrar en la aplicación para saber si tengo algún mensaje?</font></h2> &bull; ¡Claro que no! Nuestro chat, fácil e intuitivo de usar, se actualiza cada 20 segundos para que nuestros usuarios " +
